...
interface HeroflowforgeBlockProps {
    id: string;
    className?: string;
}
export function HeroflowforgeBlock({ id, className }: HeroflowforgeBlockProps) {
    return (<>
      <motion.g id="flowforge-block" className={className} initial={{ y: 0 }} animate={{ y: -10 }} transition={{
            duration: 2,
            repeat: Infinity,
            repeatType: "reverse",
            ease: "easeInOut",
