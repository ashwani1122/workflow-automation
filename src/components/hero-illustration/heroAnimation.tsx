...
import { HeroMiddleIllustration } from "./hero-svg-middle";
import { HeroBottomIllustration } from "./Hero-svg-bottom";
// import { HeroIllustration } from "../hero-illustrations/Hero-svg-flowforge";
