   ...
   return (<div className="flex flex-col items-center pt-3 md:pt-4">
            ...
            <div className="relative z-20 flex w-full items-center justify-center gap-6 lg:gap-8 px-4 lg:px-0">
                ...
                `}>
                    ...
                    <div onClick={()=>router.push("/login")} className="flex items-center pr-2 lg:pr-3">
                        <motion.a href="/login" className="group bg-[#F04D26] hover:bg-[#F04D26]/90 text-white rounded-[11px] px-3.5 h-8 text-sm font-medium flex items-center gap-2 transition-[background-color,transform] duration-150 ease focus:outline-none active:scale-[0.97] motion-reduce:transition-none" initial="idle" whileHover="hover">
                            <span>Login</span>
